...
(function () {
  ...
  g.en = {
    ...
    // ---- launcher / main menu (loading -> START -> mode grid) ----
    'launch.loading': 'LOADING…',
    'launch.start': 'START',
    'mode.builder.title': 'TinyWorld Builder',
    'mode.builder.tag': 'Build solo · share · collab',
    'mode.battle.title': 'Battleworld',
    'mode.battle.tag': 'Squad island combat · fly & conquer',
    'mode.meta.title': 'Metaworld',
    'mode.meta.tag': 'Claim · build · own · trade land',
    'mode.soon.title': 'Coming soon',
    'mode.soon.tag': 'A new world is brewing',
    'lobby.back': '← Back',
    'lobby.squad': 'Squad',
    'lobby.squad.solo': 'Solo',
    'lobby.squad.duos': 'Duos',
    'lobby.squad.trios': 'Trios',
    'lobby.squad.quads': 'Quads',
    'lobby.role': 'Role',
    'lobby.role.pilot': 'Pilot',
    'lobby.role.gunner': 'Gunner',
    'lobby.role.engineer': 'Engineer',
